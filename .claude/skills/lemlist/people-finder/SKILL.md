...
name: people-finder
description: >
  Translates an ICP and persona definition into a step-by-step guide for configuring
  lemlist's people database search to find the right contacts. Use when asked "find me contacts",
  "who do I search for in lemlist", "how do I find the right person to email",
  "build a contact list in lemlist", "search for [role] in lemlist", or after list-builder
  routes to contact-level targeting. Produces a pedagogical, step-by-step filter guide
  tailored to the ICP and persona.
---
