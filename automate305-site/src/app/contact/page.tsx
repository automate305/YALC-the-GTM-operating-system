            ...
            <div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-100 flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://cal.com/automate305" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#7B3FF2] text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-[#6930d4] transition-colors">Book on Cal.com →</a>
                </div>
              </div>
            </div>
